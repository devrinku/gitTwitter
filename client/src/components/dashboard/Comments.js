...
const Comments = ({
  ...
  return singlePost === null ? (
    <div className="mid-container padding-top text-center">
      <div className="my-3">
    ...
    <div className="mid-container padding-top">
      <p className="small fw-500 px">
        <i className="fas fa-exclamation-triangle mx"></i>
        Post not found
      </p>
    </div>
  ) : (
            ...
            <div key={comment._id} className="post  ">
              <div className="post-info ">
                <div className="post-img">
                  <img src={`/./../../uploads/${comment.user.image}`} alt="" />
                </div>
